...
To run the entire project in production mode just type `docker compose up -d --build` in the root folder of the repository. This is a **simulation** of a production environment on your local machine.

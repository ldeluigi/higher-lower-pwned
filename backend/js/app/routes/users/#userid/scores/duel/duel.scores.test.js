...
describe("scores royale API", function () {
  it("should GET duel user score after login", async () => {
  ...
  it("should GET duel/win user score after login", async () => {
    const mock = jest.spyOn(user.schema, 'findOne');
    const userMock = {
      username: "testusername",
      _id: "testid",
  ...
  it("should GET duel/lose user score after login", async () => {
    const mock = jest.spyOn(user.schema, 'findOne');
    const userMock = {
      username: "testusername",
      _id: "testid",
